...
const fontStylesMapping:Record<string,FontStyles> = {
    ...
    // Add other languages and their corresponding font sizes
};
...
const Intro: React.FC = () => {
    ...
    // };
    const fontStyles = fontStylesMapping[i18n.language] || fontStylesMapping.en;
    return (
...
const About: React.FC = () => {
    ...
    const fontStyles: FontStyles = fontStylesMapping[i18n.language] || fontStylesMapping.en;
    return (
            ...
            <div className="pt-32 scroll-mt-32 h-[100vh] flex gap-5 max-md:flex-col max-md:gap-0 bg-opacity-95">
                <div className="flex flex-col w-[66%] max-md:ml-0 max-md:w-full">
                    <div className={`flex flex-col self-stretch px-20 py-16 my-auto w-full font-bold whitespace-nowrap rounded-[51px] max-md:px-5 max-md:mt-10 max-md:max-w-full ${isBlack ? 'bg-indigo-400 bg-opacity-20' : 'bg-sky-600 bg-opacity-20'}`}>
                        ...
                        <div className={`${fontStyles.subtitle} mt-10 max-md:max-w-full whitespace-pre-line`}>
                ...
                <div className="flex flex-col ml-5 w-[40%] max-md:ml-0 max-md:w-full">
                    <img
                        ...
                        className="mt-40 w-full max-md:max-w-full"
                    />
                </div>
            </div>
        </div>
...
const Cache: React.FC = () => {
    ...
    return (
        <div id="Cache$RAM" className="pt-5 scroll-mt-32 h-[100vh] flex flex-col px-7 pb-8 rounded-[51px] max-md:px-5" style={commonStyles}>
            <div className={`${fontStyles.slogan} self-center font-bold max-md:max-w-full`}>
                {t('Cache$RAM')}
            </div>
            <div className="w-full h-2 border border-violet-700 bg-violet-700"></div>
            <div className={`${fontStyles.subtitle} mt-7 text-center max-md:max-w-full`}>
            ...
            <div className="mt-14 max-md:mt-10 max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                    ...
                    <div className="flex flex-col w-1/3 max-md:ml-0 max-md:w-full">
                        <div className={`${fontStyles.subtitle} flex flex-col grow items-center font-bold text-center max-md:mt-6 max-md:max-w-full`}>
                            <p className=' mb-3'>{t('高可靠性和極小尺寸')}</p>
                            <div className="w-full h-1 border border-violet-700 bg-violet-700"></div>
                            <div className={`${fontStyles.body} mt-4 w-[491px]`}>
                                {t('雙電晶體結構無須額外電容')}
                            </div>
                            <div className={`${fontStyles.subtitle} mb-3 mt-12 max-md:mt-10`}>{t('低操作電壓')}</div>
                            <div className="w-full h-1 border border-violet-700 bg-violet-700"></div>
                            <div className={`${fontStyles.body} mt-4 `}>{t('核心電路最高電壓')}</div>
                            <div className={`${fontStyles.subtitle} mb-3 mt-12 max-md:mt-10 max-md:max-w-full`}>
                                {t('更廣泛的適用性以適配第三級快取')}
                            </div>
                            <div className="w-full h-1 border border-violet-700 bg-violet-700"></div>
                            <div className={`${fontStyles.body} mt-4`}>{t('可與最後緩存規格媲美')}</div>
                        </div>
                    </div>
                    {/* middle image */}
                    ...
                    {/* right container */}
                    <div className="flex flex-col ml-5 w-1/3 max-md:ml-0 max-md:w-full">
                        <div className={`${fontStyles.subtitle} flex flex-col items-center font-bold text-center max-md:mt-6 max-md:max-w-full`}>
                            <div className=' mb-3'>{t('低成本')}</div>
                            <div className="w-full h-1 border border-violet-700 bg-violet-700"></div>
                            <div className={`${fontStyles.body} mt-4`}>{t('無須額外光罩')}</div>
                            <div className={`${fontStyles.subtitle} mb-3 mt-12 max-md:mt-10`}>{t('設計應用的靈活性')}</div>
                            <div className="w-full h-1 border border-violet-700 bg-violet-700"></div>
                            <div className={`${fontStyles.body} mt-4`}>{t('數十微秒')}</div>
                            <div className={`${fontStyles.subtitle} mb-3 mt-12 max-md:mt-10`}>
                                {t('更長的週期性刷新時間保留')}
                            </div>
                            <div className="w-full h-1 border border-violet-700 bg-violet-700"></div>
                            <div className={`${fontStyles.body} mt-3 max-md:max-w-full`}>
            ...
            <div className={`${fontStyles.title} self-center pt-3 mb-3 font-bold text-teal-300 text-opacity-80 max-md:mt-10 max-md:text-4xl ${isBlack ? ' text-teal-300':'text-teal-900'}`}>
                {t('雙電晶體結構')}
            </div>
            <div className={`${fontStyles.body} mt-1 text-center max-md:max-w-full`}>
...
const AVAXOTP: React.FC = () => {
    ...
    const fontStyles: FontStyles = fontStylesMapping[i18n.language] || fontStylesMapping.en;
    return (
        <div id="AVAXOTP" className="pt-5 scroll-mt-32 h-[100vh] flex flex-col rounded-[51px] items-center" style={commonStyles}>
            ...
            <p className={`${fontStyles.subtitle} mt-6 text-center max-md:max-w-full`}>
            ...
            <div className="flex flex-col items-center px-7 mt-6 w-full max-md:px-5">
                <div className="mt-8 w-full flex max-md:flex-col">
                    ...
                    <div className="w-1/3 flex flex-col max-md:w-full">
                        <div className={`${fontStyles.subtitle} flex flex-col items-center mb-5 font-bold text-center whitespace-nowrap`}>
                            {t('絕佳的資料儲存空間')}
                        </div>
                        <div className="w-full h-1 border border-violet-700 bg-violet-700"></div> {/* 容器內的最細，高度設置為 1 */}
                        <p className={`${fontStyles.body} mt-5 text-center font-bold`}>
                            {t('資料可以在攝氏200度的環境維持一個月')}
                        </p>
                        <div className={`${fontStyles.subtitle} flex flex-col items-center font-bold text-center mt-14 mb-5`}>
                            {t('低操作電壓')}
                        </div>
                        <div className="w-full h-1 border border-violet-700 bg-violet-700"></div> {/* 容器內的最細，高度設置為 1 */}
                        <p className={`${fontStyles.body} mt-5 font-bold text-center`}>
                            {t('核心電路最高電壓')}
                        </p>
                    </div>
                    {/* 中間圖片容器 */}
                    ...
                    <div className="w-1/3 flex flex-col items-center max-md:w-full">
                        <div className={`${fontStyles.subtitle} mb-5 flex flex-col items-center font-bold text-center`}>
                            {t('低成本')}
                        </div>
                        <div className="w-full h-1 border border-violet-700 bg-violet-700"></div> {/* 容器內的最細，高度設置為 1 */}
                        <p className={`${fontStyles.body} mt-5 text-center font-bold`}>
                        ...
                        <div className={`${fontStyles.subtitle} mt-14 mb-5 flex flex-col items-center font-bold text-center`}>
                            {t('極小尺寸')}
                        </div>
                        <div className="w-full h-1 border border-violet-700 bg-violet-700"></div> {/* 容器內的最細，高度設置為 1 */}
                        <p className={`${fontStyles.body} self-stretch mt-7 text-center font-bold`}>
                            {t('雙電晶體架構無須額外的電容器')}
                        </p>
                    </div>
                </div>
                <div className="w-[500px] h-2 bg-violet-700"></div>
                <p className={`${fontStyles.subtitle} mt-4 text-center font-bold`}>
                    {t('不可追蹤性')}
                </p>
            </div>
            <h2 className={`${fontStyles.subslogan} mt-12 font-bold text-teal-300 text-opacity-80 max-md:mt-10 max-md:text-4xl ${isBlack ? ' text-teal-300':'text-teal-900'}`}>
                {t('專為資安和物聯網設計 具備可擴展性及穩定性的單元')}
            </h2>
            <p className={`${fontStyles.body} mt-6 text-center max-md:text-2xl`}>
